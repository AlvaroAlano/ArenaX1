...
1.1. O controlador dos dados pessoais tratados nesta Política é [RAZÃO
SOCIAL COMPLETA], CNPJ [CNPJ], com sede em [ENDEREÇO COMPLETO]
(**"ArenaX1"**, **"nós"**).
...
- **Login social:** se você entrar via Google, recebemos as informações
  básicas de perfil autorizadas por você naquele momento (nome, e-mail,
  foto).
- **Comunicação:** mensagens enviadas nos chats de partida/disputa e nos
  tickets de suporte.

### 2.2. Dados financeiros
- **Transações:** valores depositados, sacados, apostados e recebidos;
...
- Endereço IP, identificadores de dispositivo, data/hora de acesso,
  páginas acessadas — coletados para segurança, prevenção a fraude e
  cumprimento de obrigação legal (Seção 6.3).

### 2.4. Dados de partidas e desafios
- Histórico de desafios e torneios criados, participados, resultados
  reportados, disputas abertas e suas resoluções, nota de reputação
  (Fair Play) e contador de ausências.
...
|---|---|
| Criar e manter sua conta, permitir login | Execução de contrato |
| Verificar sua idade (maioridade) | Cumprimento de obrigação legal (Lei nº 15.211/2025) |
| Processar depósitos e saques | Execução de contrato |
| Prevenir fraude (matching de CPF, monitoramento de padrão de transação) | Legítimo interesse / cumprimento de obrigação legal |
| Resolver disputas entre usuários | Execução de contrato |
| Calcular e exibir reputação (Fair Play, contador de ausência) | Execução de contrato / legítimo interesse |
| Enviar notificações sobre suas partidas, carteira e conta | Execução de contrato |
| Responder solicitações de suporte | Execução de contrato |
| Cumprir obrigações legais de guarda de registro (Marco Civil da Internet) | Cumprimento de obrigação legal |
| Investigar e comunicar suspeita de fraude/lavagem, quando aplicável | Cumprimento de obrigação legal / legítimo interesse |

Não usamos seus dados para decisões automatizadas que produzam efeitos
jurídicos significativos sem possibilidade de revisão humana — toda
penalidade reputacional relevante (redução de nota, selo público) passa
por um processo com possibilidade de contestação antes de se tornar
pública ou definitiva.

---

## 4. Com quem compartilhamos seus dados

4.1. **Provedor de pagamento (gateway Pix):** para processar depósitos e
...
6.1. **Enquanto sua conta estiver ativa**, mantemos seus dados para
...
- **Técnico:** o registro é referenciado por desafios, disputas e
  torneios que envolveram outros usuários — removê-lo quebraria o
...
Nos termos da LGPD, você pode solicitar a qualquer momento, pelo nosso
canal de suporte:
...
- **Portabilidade** dos seus dados a outro fornecedor de serviço, quando
...
Respondemos às solicitações em até 15 (quinze) dias. Alguns pedidos
(como exclusão) podem exigir a conclusão do fluxo de exclusão de conta
descrito nos Termos de Uso, incluindo o saque de saldo pendente e a
resolução de desafios/disputas em andamento.

---

## 8. Segurança

8.1. Adotamos medidas técnicas e administrativas para proteger seus dados
contra acesso não autorizado, incluindo: senhas armazenadas como hash com
salt (nunca em texto legível), controle de acesso por função (apenas o
backend, com credenciais próprias, pode alterar saldo ou dados sensíveis),
e segregação de permissões por usuário (cada um só acessa os próprios
dados).

8.2. Nenhum sistema é 100% imune a incidentes. Em caso de incidente de
segurança que possa acarretar risco a você, comunicaremos conforme exigido
pela LGPD.
...
9.1. A Plataforma não é destinada a menores de 18 anos e adota mecanismo
de verificação de idade no cadastro (Seção 5). Não coletamos
...
11.1. Podemos atualizar esta Política periodicamente. Alterações
relevantes serão comunicadas com antecedência razoável pela Plataforma ou
e-mail cadastrado.
