    ...
    <main class="flex-1 flex items-center justify-center p-4 lg:p-12 relative z-10">
      <div class="w-full max-w-[1280px] grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div class="hidden lg:flex flex-col gap-10 w-full max-w-xl mx-auto">
          <div class="relative rounded-xl overflow-hidden border border-hairline aspect-[4/3] group">
            <img 
            ...
            <div class="absolute bottom-10 left-10 right-10">
              <span class="inline-block bg-primary text-on-primary text-[11px] font-bold px-3 py-1.5 rounded-sm uppercase tracking-widest mb-4">
                BEM-VINDO DE VOLTA
              </span>
          ...
          <form @submit.prevent="handleLogin" class="space-y-4">
            ...
            <div class="relative group">
              ...
              <input
                ...
                autocomplete="email"
                required
                class="w-full bg-surface-2 border border-hairline rounded-md pl-12 pr-4 py-3.5 text-ink placeholder-ink-tertiary focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition text-body-sm"
              />
            </div>
            ...
            <div class="relative group">
              ...
              <input
                ...
                required
                class="w-full bg-surface-2 border border-hairline rounded-md pl-12 pr-12 py-3.5 text-ink placeholder-ink-tertiary focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition text-body-sm"
              />
              <button
                type="button"
            ...
            <button 
              type="submit" 
              :disabled="loading" 
              class="w-full bg-primary hover:bg-primary-hover text-on-primary py-4 rounded-md font-medium text-button transition-colors disabled:opacity-50 flex items-center justify-center gap-2 mt-4"
            >
