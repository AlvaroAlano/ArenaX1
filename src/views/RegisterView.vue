        ...
        <div class="w-full max-w-md mx-auto px-2 lg:mx-0 lg:max-w-[480px] lg:bg-surface-1 lg:border lg:border-hairline lg:rounded-lg lg:p-10">
          ...
          <form @submit.prevent="handleRegister" class="space-y-3">
            ...
            <button 
              type="submit" 
              :disabled="loading" 
              class="w-full bg-primary hover:bg-primary-hover text-on-primary py-4 rounded-md font-medium text-button transition-colors disabled:opacity-50 flex items-center justify-center gap-2 mt-2"
            >
