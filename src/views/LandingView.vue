    ...
    >
      <div class="max-w-[1280px] mx-auto px-6 lg:px-12 h-14 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-3">
          ...
          <router-link to="/register" class="bg-primary hover:bg-primary-hover text-on-primary px-4 py-2 rounded-md text-button font-medium transition-colors">
            Criar Conta
          </router-link>
        </div>
        ...
        >
          <svg v-if="!isNavOpen" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" /></svg>
          <svg v-else class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" /></svg>
        </button>
      </div>
      ...
      >
        <div v-if="isNavOpen" class="md:hidden bg-surface-1 border-b border-hairline px-6 py-6 space-y-4">
          ...
          <div class="pt-4 border-t border-hairline flex flex-col gap-3">
            ...
            <router-link to="/register" class="bg-primary text-on-primary text-center px-4 py-3 rounded-md text-button font-medium">Criar Conta</router-link>
          </div>
        </div>
      </transition>
    </nav>
      ...
      <div class="max-w-[1280px] mx-auto relative z-10">
        <div class="max-w-3xl mx-auto text-center">
          ...
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <router-link to="/register" class="w-full sm:w-auto bg-primary hover:bg-primary-hover text-on-primary px-8 py-4 rounded-md text-button font-medium transition-colors text-center">
      ...
      <div class="max-w-[1280px] mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div 
            ...
            :key="index"
            class="bg-surface-1 border border-hairline rounded-lg p-6 relative group hover:border-primary/30 transition-colors duration-300"
          >
      ...
      <div class="max-w-[1280px] mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div 
            ...
            :key="index"
            class="bg-surface-1 border border-hairline rounded-lg p-6 group hover:border-primary/30 transition-colors duration-300"
          >
