    ...
    <div v-else class="space-y-8">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-surface-1 border border-hairline p-6 rounded-lg ">
        ...
        <div class="flex gap-3">
          <button class="bg-surface-3 hover:bg-[#2e3543] border border-hairline-strong text-ink px-5 py-3 rounded-lg font-bold transition-all text-sm">
            Editar Perfil
          </button>
          <button class="bg-primary hover:bg-primary-hover text-ink px-5 py-3 rounded-lg font-bold shadow-none transition-all text-sm">
            Jogar X1
          </button>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <!-- Card Carteira -->
        <div class="bg-surface-1 border border-hairline hover:border-primary p-6 rounded-lg shadow-none transition-all duration-300 relative overflow-hidden group">
        ...
        <!-- Card de Plataformas -->
        <div class="bg-surface-1 border border-hairline p-6 rounded-lg shadow-none">
        ...
        <div class="bg-surface-1 border border-hairline p-6 rounded-lg shadow-none flex flex-col justify-between">
          <div>
          ...
          <button class="w-full bg-surface-2 hover:bg-[#262b35] border border-hairline-strong text-ink py-3 rounded-lg font-bold transition-all text-sm mt-4">
